        ...
        <div className="twitch">
          <div className="video">
            <iframe
              ...
              src={`https://player.twitch.tv/?channel=${featured.channel.display_name}&autoplay=true`}
              frameBorder="0"
            />
            <a
          ...
          <iframe
            className="chat"
            src={`https://www.twitch.tv/embed/${featured.channel.display_name}/chat?darkpopout`}
          />
        </div>
      </div>
    </div>
